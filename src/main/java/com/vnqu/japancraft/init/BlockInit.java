...
import com.vnqu.japancraft.objects.blocks.Shoji;
...
public class BlockInit
{
    ...
    public static void registerBlocks(final RegistryEvent.Register<Block> event)
    {
        ...
        event.getRegistry().register(new LeavesBlock(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT).func_226896_b_()).setRegistryName(JapanCraft.MOD_ID, "sakura_leaves"));
